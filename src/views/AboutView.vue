<template>
  ...
  <div>
    ...
    <template v-slot:default>
      ...
      <tbody>
        <tr
        v-for="BookInfos in BookInfo" :key="BookInfos"
        >
  ...
  >
                ...
                </v-btn> {{ BookInfos.quantity }} <v-btn
             small
              @click="
                increment(
                  BookInfos.cartId,
    ...
    <v-list-item three-line>
      <v-list-item-content>
         ...
         <div
              ...
              >
                ...
                <div class="total">
                  <div class="caption">
                    <p>
                      <strong>BookName:{{ BookInfos.book.bookName }}</strong>
                    </p>
       ...
       Subtotal:{{ BookInfo.total }}
        ...
        <v-list-item-subtitle>Shipping:FreeShipping</v-list-item-subtitle>
      </v-list-item-content>
